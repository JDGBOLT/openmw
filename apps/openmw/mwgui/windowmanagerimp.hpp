...
namespace MWGui
{
  ...
  public:
    ...
    void notifyMouseWheel(int rel) override;
    ...
    MWGui::QuickKeysMenu* getQuickKeysMenu() override;
    MWGui::QuickLoot* getQuickLoot() override;
    ...
    void setKeyTooltip(bool enable) override;
    bool isKeyTooltip() const override;
