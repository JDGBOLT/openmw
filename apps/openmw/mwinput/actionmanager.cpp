...
namespace MWInput
{
    ...
    void ActionManager::executeAction(int action)
    {
        ...
        case A_ToggleDebug:
            ...
            break;
        case A_ZoomIn:
            if (inputManager->getControlSwitch("playerviewswitch") && inputManager->getControlSwitch("playercontrols") && !windowManager->isGuiMode() && !windowManager->getQuickLoot()->isVisible())
